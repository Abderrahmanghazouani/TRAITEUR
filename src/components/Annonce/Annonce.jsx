...
export default function Annonce() {
  ...
  return (
    <div className="container mx-auto mt-10 px-4 py-8 bg-[#f7f1e9]  shadow-md rounded-lg border border-black">
      <h5 className="text-3xl font-bold mb-6 text-center text-black mt-6">Liste des Nouvelles Annonces</h5>
