...
import bgImg from"../../assets/pic-5.jpg"
// import Food1 from "../../assets/pic-1.jpg"
// import Food2 from "../../assets/pic-2.jpg"
// import Food3 from "../../assets/pic-3.jpg"
        ...
        <div className="container pb-8 sm:pb-0">
          <div className="grid grid-cols-1 sm:grid-cols-2">
            ...
            {/* <div className="min-h-[450px] sm:min-h-[450px] flex justify-center items-center relative order-1 sm:order-2  ">
              <div className="h-[300px] sm:h-[450px] overflow-hidden flex justify-center items-center rounded-full object-cover">
                <img
                  data-aos="zoom-in"
